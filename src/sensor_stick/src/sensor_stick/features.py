...
def compute_normal_histograms(normal_cloud):
    ...
    channel_1_hist, bin_edges = np.histogram(channel_1_vals, bins=32, range=(-1,1)) 
    channel_2_hist, bin_edges = np.histogram(channel_2_vals, bins=32, range=(-1,1))
    channel_3_hist, bin_edges = np.histogram(channel_3_vals, bins=32, range=(-1,1))
